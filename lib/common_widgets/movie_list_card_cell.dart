...
class CardListCell {
  static Widget buildCardCell(int index, BuildContext context,
      List<Movie> movielist, Function cardDidTap) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          movieTwo != null
              ? (cardWidget(movieTwo, indexTwo, context, cardDidTap))
              : Container(),
          // SizedBox(width: 10,),
            ...
            children: <Widget>[
              Container(
                  ...
                  child: getNeworkImage(
                      '${kPosterImageBaseUrl}w500${movie.posterPath ?? movie.backdropPath}')),
              Positioned(
                left: 0,
                bottom: 0,
                height: 60,
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      child: buildRating(movie.voteAverage ?? 0),
                    ),
                    Text(
