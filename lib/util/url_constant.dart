...
const String kAccessToken =
    'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1OTk1ZTVlNDE4OWQxZDBlOTY0ZTMzMzBhYTViMTM0YyIsInN1YiI6IjVkMmFiOGM3YTI5NGYwMjg0NjJkOWUzYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ._L7-GNm5o5Aq3yb4Fv_38a30aPxFYA_uoovOmBJzEgk';

const String kBaseUrl = 'https://api.themoviedb.org/3';

const String kRequestTokenUrl =
    '$kBaseUrl/authentication/token/new?api_key=$kApiKey';
...
const String kTrendingMovieUrl =
    '$kBaseUrl/trending/movie/day?api_key=$kApiKey&page=';
...
String getDetailUrl(int movieId) {
  var url =
      '$kBaseUrl/movie/$movieId?api_key=$kApiKey&append_to_response=images';
  return url;
}
...
String getMovieUrlWithGenre(int genreId, int pageNo) {
  var url =
      '$kBaseUrl/discover/movie?api_key=$kApiKey&sort_by=popularity.desc&include_adult=false&include_video=false&page=$pageNo&with_genres=$genreId';
  return url;
}

String getSearchUrl(String text, int pageNo) {
  var url =
      '$kBaseUrl/search/movie?api_key=$kApiKey&language=en-US&query=$text&page=$pageNo&include_adult=false';
  return url;
}
