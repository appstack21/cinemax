                  ...
                  child: Container(
                    child: Column(
                      children: <Widget>[
                        ...
                        nowPlaying != null
                            ? _buildMovieList(context, nowPlaying ?? [],
                                MovieListType.NowPaying)
                            : Container(),
                        upcomingList != null
                            ? _buildMovieList(context, upcomingList ?? [],
                                MovieListType.Upcoming)
                            : Container(),
                        popularList != null
                            ? _buildMovieList(context, popularList ?? [],
                                MovieListType.Popular)
                            : Container(),
                        trendingList != null
                            ? _buildMovieList(context, trendingList ?? [],
                                MovieListType.Trending)
                            : Container(),
                        topRatedList != null
                            ? _buildMovieList(context, topRatedList ?? [],
