...
class MovieDetail {
  ...
  factory MovieDetail.fromMap(Map<String, dynamic> json) => new MovieDetail(
        ...
        genres: json["genres"] == null
            ? null
            : new List<Genre>.from(json["genres"].map((x) => Genre.fromMap(x))),
        ...
        releaseDate: json["release_date"] == null
            ? null
            : (json["release_date"].toString().length == 0
                ? DateTime.now()
  ...
  Map<String, dynamic> toMap() => {
        ...
        "genres": genres == null
            ? null
            : new List<dynamic>.from(genres!.map((x) => x.toMap())),
